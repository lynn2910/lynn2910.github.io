...
<Navbar hidden={shouldHideNavbar}>
    {#snippet main()}
        ...
        <div class="flex flex-row items-center justify-between gap-10">
            <a href="{base}" class="font-semibold" title="Page d'accueil" aria-label="Page d'accueil">
            ...
            <div class="w-full row content-center justify-center gap-2">
                <NavDropDown
                        title="Portfolios spécifiques"
                        items={[
                        {label: "Stage 2025", url: `${base}/stage-2025`},
                    ]}>
                </NavDropDown>
            </div>
